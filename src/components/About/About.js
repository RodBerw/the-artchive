...
export default function About() {
  ...
  return (
    <div>
      <Flex w="80%" justifyContent="center" m="auto" bg="black" mt={{ base: "250px", md: "300px", xl: "350px" }} mb="300px">
        <Box w="80%" m="auto" bgImg="./assets/oil_background.jpg" textAlign="center" pb="100px" top="-100px" mt={m} mb={m}>
          <Flex flexDirection="column" alignItems="center" m="0 10% 0 10%">
            ...
            <Box position="relative" w="100%" h={{ base: "400px", md: "500px", xl: "600px" }} mb="50px">
              <Flex w="50%" position="absolute" zIndex="3" flexDirection="column" alignItems="start" mt="20%" gap="1vw" color="white" textAlign="start">
              ...
              <Image w={{base: "500px", md: "700px", xl: "900px"}} bottom="-150px" right="-40%" position="absolute" zIndex="2" src="./assets/about-painting.png"></Image>
            </Box>
          </Flex>
        </Box>
      </Flex>
