...
export default function Category(props){
    ...
    return(
        <div>
            <Flex h="100%">
                <Square position="relative" alignSelf={props.marginTop} size={{base:"22vw", md:"21vw", xl:"20vw"}} minW="200px" minH="200px" onMouseEnter={() => {setYOffset("-1vw"); setImgZoom(10)}} onMouseLeave={() => {setYOffset("0vw"); setImgZoom(0)}} _hover={{cursor: "pointer"}}>
